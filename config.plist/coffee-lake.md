...
* [SSDT-AWAC](https://github.com/acidanthera/OpenCorePkg/blob/master/Docs/AcpiSamples/SSDT-AWAC.dsl)
  * This is the [300 series RTC patch](https://www.hackintosh-forum.de/forum/thread/39846-asrock-z390-taichi-ultimate/?pageNo=2), required for most B360, B365, H310, H370, Z390 which prevent systems from booting macOS. Aternative is [SSDT-RTC0](https://github.com/acidanthera/OpenCorePkg/blob/master/Docs/AcpiSamples/SSDT-RTC0.dsl) for when AWAC SSDT doesn't work\(Z370 users shouldn't need this but some BIOS vendors started sending updaes that force the system clock to be AWAC without any GUI settings\)
...
**Add**: Here's where you specify which kexts to load, order matters here so make sure Lilu.kext is always first! Other higher priority kexts come after Lilu such as VirtualSMC, AppleALC, WhateverGreen, etc. Please see the [Kext section](https://github.com/chriswayg/Opencore-Visual-Beginners-Guide/tree/f721d65fd6c56476f974347e928aecd1e3deb7cb/config.plist/ktext/README.md#kexts) for what kexts we recommend.
...
* **ScanPolicy**: `0` 
  * `0` allows you to see all drives available, please refer to [Security](https://github.com/chriswayg/Opencore-Visual-Beginners-Guide/tree/f721d65fd6c56476f974347e928aecd1e3deb7cb/config.plist/post-install/security-and-filevault.md) section for furthur details
