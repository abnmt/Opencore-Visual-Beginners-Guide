...
**Add**: Here's where you specify which kexts to load, order matters here so make sure Lilu.kext is always first! Other higher priority kexts come after Lilu such as VirtualSMC, AppleALC, WhateverGreen, etc. Please see the [Kext section](https://github.com/chriswayg/Opencore-Visual-Beginners-Guide/tree/f721d65fd6c56476f974347e928aecd1e3deb7cb/AMD/ktext/README.md#kexts) for what kexts we recommend.
